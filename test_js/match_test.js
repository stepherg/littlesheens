// This array comes from https://github.com/Comcast/sheens/blob/master/core/match_test.js
//
// ./mdemo match_test.js | tee result.js | jq -r '.[]|select(.happy == false)|"\(.n): \(.case.title); wanted: \(.case.w) got: \(.bss)"'
